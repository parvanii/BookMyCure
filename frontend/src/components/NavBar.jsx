      ...
      <div className="flex items-center gap-4">
        {
          ...
          <div className='flex items-center gap-2 cursor-pointer group relative'> 
            <img className='w-8 rounded-full'src={"/images/profile_pic.png"} alt=""/>
          ...
          :<button onClick={()=>navigate('/login')}className="group w-[140px] h-[40px] flex justify-center items-center gap-2 rounded-[47px] bg-[#6a994e] px-6 py-2 font-poppins text-white text-[15px] transition-all hover:bg-[#6a994e]">
